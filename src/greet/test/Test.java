...
public class Test extends JLayeredPane {
    ...
    private JLabel[][] panelGrid = new JLabel[GRID_ROWS][GRID_COLS];
    ...
    public Test() {
        ...
        for (int row = 0; row < GRID_ROWS; row++) {
            for (int col = 0; col < GRID_COLS; col++) {
                panelGrid[row][col] = new JLabel("Black");
                panelGrid[row][col].setLayout(new GridBagLayout());
                panelGrid[row][col].setBackground(Color.black.brighter().brighter());
        ...
        add(backingPanel);
        Test.MyMouseAdapter myMouseAdapter = new Test.MyMouseAdapter();
    ...
    private class MyMouseAdapter extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent me) {
            ...
            JLabel droppedPanel = (JLabel) backingPanel.getComponentAt(me.getPoint());
