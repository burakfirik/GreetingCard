...
public class GreetCanvasState {
     ...
     */
    public GreetCanvasState( boolean initZoomable,
                            GreetPose initPose,
                            float initZoomLevel,
     ...
     */
    public TemplateCanvas getCanvas() { return canvas; }
     ...
     */
    public void setPoseCanvas(TemplateCanvas initCanvas)
    {
